...
var filter_RealtimeAnalyticsService_GetRealtimeQueryData_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}

func request_RealtimeAnalyticsService_GetRealtimeQueryData_0(ctx context.Context, marshaler runtime.Marshaler, client RealtimeAnalyticsServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GetRealtimeQueryDataRequest
		metadata runtime.ServerMetadata
	)
	if req.Body != nil {
		_, _ = io.Copy(io.Discard, req.Body)
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_RealtimeAnalyticsService_GetRealtimeQueryData_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	msg, err := client.GetRealtimeQueryData(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_RealtimeAnalyticsService_GetRealtimeQueryData_0(ctx context.Context, marshaler runtime.Marshaler, server RealtimeAnalyticsServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GetRealtimeQueryDataRequest
		metadata runtime.ServerMetadata
	)
	...
	msg, err := server.GetRealtimeQueryData(ctx, &protoReq)
	return msg, metadata, err
}
...
func RegisterRealtimeAnalyticsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RealtimeAnalyticsServiceServer) error {
	...
	mux.Handle(http.MethodGet, pattern_RealtimeAnalyticsService_GetRealtimeQueryData_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/realtimeanalytics.v1.RealtimeAnalyticsService/GetRealtimeQueryData", runtime.WithHTTPPathPattern("/v1/realtime/query-data"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_RealtimeAnalyticsService_GetRealtimeQueryData_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_RealtimeAnalyticsService_GetRealtimeQueryData_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterRealtimeAnalyticsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RealtimeAnalyticsServiceClient) error {
	...
	mux.Handle(http.MethodGet, pattern_RealtimeAnalyticsService_GetRealtimeQueryData_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/realtimeanalytics.v1.RealtimeAnalyticsService/GetRealtimeQueryData", runtime.WithHTTPPathPattern("/v1/realtime/query-data"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_RealtimeAnalyticsService_GetRealtimeQueryData_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_RealtimeAnalyticsService_GetRealtimeQueryData_0      = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "realtime", "query-data"}, ""))
)
...
var (
	...
	forward_RealtimeAnalyticsService_GetRealtimeQueryData_0      = runtime.ForwardResponseMessage
)
